...
@rem cl src/gl-3-glfw.cpp %debug% %paths% /link user32.lib opengl32.lib gdi32.lib Winmm.lib /out:exe\gl3-glfw.exe
cl src/gl-3-gpt.cpp %debug% %paths% /link user32.lib opengl32.lib gdi32.lib Winmm.lib /out:exe\gl3-gpt.exe
